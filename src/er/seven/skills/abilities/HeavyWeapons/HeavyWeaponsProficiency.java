package er.seven.skills.abilities.HeavyWeapons;
...
public class HeavyWeaponsProficiency extends Ability
{
	@Override
	public Skill getSkill() { return Skill.HEAVY_WEAPONS; }
