...
public class FarmingEfficiency extends Ability
{
	@Override
	...
	{ 
		return "Crops have a " + ChatColor.GOLD + (int)(getSkill().getLevel(player) * Main.mainConfig.getDouble("Trade.DoubleDropsChance")) + ChatColor.GRAY + "% chance for double drops.";
	}
