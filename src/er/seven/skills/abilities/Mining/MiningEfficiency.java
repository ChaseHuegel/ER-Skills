...
public class MiningEfficiency extends Ability
{
	@Override
	...
	{ 
		return "Mining has a " + ChatColor.GOLD + (int)(getSkill().getLevel(player) * Main.mainConfig.getDouble("Trade.DoubleDropsChance")) + ChatColor.GRAY + "% chance for double drops.";
	}
