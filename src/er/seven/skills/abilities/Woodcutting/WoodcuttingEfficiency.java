...
public class WoodcuttingEfficiency extends Ability
{
	@Override
	...
	{ 
		return "Woodcutting has a " + ChatColor.GOLD + (int)(getSkill().getLevel(player) * Main.mainConfig.getDouble("Trade.DoubleDropsChance")) + ChatColor.GRAY + "% chance for double drops.";
	}
