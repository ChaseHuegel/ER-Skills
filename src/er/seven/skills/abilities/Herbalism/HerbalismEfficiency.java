...
public class HerbalismEfficiency extends Ability
{
	@Override
	...
	{ 
		return "Plants have a " + ChatColor.GOLD + (int)(getSkill().getLevel(player) * Main.mainConfig.getDouble("Trade.DoubleDropsChance")) + ChatColor.GRAY + "% chance for double drops.";
	}
