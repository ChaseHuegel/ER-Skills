...
{	
	...
	@Override public String 		getName() 			{ return "Yeti"; }
	...
	public List<Biome> validBiomes = Arrays.asList(
			Biome.SNOWY_BEACH, Biome.SNOWY_MOUNTAINS, Biome.SNOWY_TAIGA, Biome.SNOWY_TAIGA_HILLS, Biome.SNOWY_TAIGA_MOUNTAINS, Biome.SNOWY_TUNDRA, Biome.ICE_SPIKES
			);
